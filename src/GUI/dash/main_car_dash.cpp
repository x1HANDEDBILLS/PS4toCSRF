...
void MainCarDash::refresh_theme() {
    ...
    telemetry_placeholder->setStyleSheet(QString("color: %1; font-family: 'Consolas'; font-size: 30px; border: 2px solid %2; padding: 20px; background: rgba(0, 0, 0, 50);").arg(silver, accent));
}
